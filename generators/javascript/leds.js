...
Blockly.JavaScript['chainable_rgb_led_set'] = function(block) {
  ...
  var color = Blockly.JavaScript.valueToCode(block, 'COLOUR', Blockly.JavaScript.ORDER_ATOMIC);
  var code = "setChainableRgbLed(" + ledId + "," + color.substring(1, color.length - 1) + ");";
  return code;
};
